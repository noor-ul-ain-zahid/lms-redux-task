...
import { addPublisher, deletePublisher, editPublisherDetails } from '../../actions/Actions';
...
class Publishers extends React.Component {
    ...
    editPublisherDetails = (publisher) => {
        ...
        if (this.notExisting(publishers, updatedData.name, updatedData.id)) {
            editPublisherDetails(publishers, this.state.selectedPublisher, updatedData)
            this.toggleState('')
            this.setState({ error: '' })
        }
        else { this.setState({ error: 'error' }) }
    ...
    deletePublisher = (publisher) => {
        this.setState({ selectedPublisher: publisher })
        this.props.deletePublisher(this.props.publishers, publisher)
    }
